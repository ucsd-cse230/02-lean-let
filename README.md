# 02-let
Homework assignment 2 for CSE 230
...
## Instructions
Follow the instructions in [Let.lean](Let.lean) to complete definitions and proofs that are currently completed using `sorry`. 
